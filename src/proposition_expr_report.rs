...
use crate::proposition_expr::{BoundedPropositionExpressionResult, PropositionExpressionResult};
use std::fmt::Write;
...
pub fn render_bounded_proposition_expression_report(
    model_name: &str,
...
fn render_header(
    ...
    writeln!(output, "expression: {expression}").expect("writing to String cannot fail");
    writeln!(
        output,
        "backend: {}",
        match backend {
